...
// ---- Pont React : sélection de module + rendu sans dépendre des listeners internes ----
if (typeof window !== 'undefined') {
    window.showLearningModule = function (m) {
        activeLearningModule = m || activeLearningModule;
        renderLearningModule();
    };
}
